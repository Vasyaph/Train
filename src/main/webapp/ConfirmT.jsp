...
<main>
    <form class="" action="PaymentVerification" method="get">
        <div class="usercart">
            <h2>
            ...
            <label class="checkbox">
                ...
                <input required class="input-text" type="text" name="Name" value="${user.getName()}">
            </label>
            <label class="checkbox">
                <fmt:message key="lastname"/>
                <input required class="input-text" type="text" name="Lastname" value="${user.getSurname()}">
            </label>

            <input type="submit" class="login mini_btn" value="Buy"> </input>
